...
def Read_SN(location):
    ...
    time_SN_vis = pd.read_csv(location+'time_SN_vis.csv')
    time_SN_vuv = pd.read_csv(location+'time_SN_vuv.csv')
...
def Read_Ar39(location):
    ...
    time_Ar_vis = pd.read_csv(location+'time_Ar_vis.csv')
    time_Ar_vuv = pd.read_csv(location+'time_Ar_vuv.csv')
